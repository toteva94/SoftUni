...
class SliciningFile
{
    static void Main()
    {
        ...
        var filesDestionation = "../../GeneratedFiles";
    ...
    static void Slice(string sourceFile, string destinationDirectory, int parts)
    {
        ...
        using (var file = new FileStream(destinationDirectory + "//" + sourceFile, FileMode.Open))
        {
            ...
            {
                using (var newFile = new FileStream(destinationDirectory + "//GeneratedFiles//part" + (i + 1) + "." + extension, FileMode.Create))
                {
